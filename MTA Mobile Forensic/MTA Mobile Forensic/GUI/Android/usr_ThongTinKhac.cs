...
namespace MTA_Mobile_Forensic.GUI.Android
{
    public partial class usr_ThongTinKhac : UserControl
    {
        ...
        public usr_ThongTinKhac()
        {
            InitializeComponent();
            LoadData();
            listView.Columns.Add("STT", (int)(2 * panelAccount.Width / 10), HorizontalAlignment.Center);
            listView.Columns.Add("Tên tài khoản", (int)(4 * panelAccount.Width / 10), HorizontalAlignment.Center);
        ...
        private void panelEx1_Resize(object sender, EventArgs e)
        {
            try
            {
                ...
                listView.Columns[2].Width = (int)(4.5 * panelAccount.Width / 10);
