...
def process(sample_audio_file_input, test_audio_file_inputs):
    ...
    results = []
    for test_audio_file_input in test_audio_file_inputs:
        print(f"test_audio_file_input: {test_audio_file_input}")
        test_audio_file = test_audio_file_input
        try:
        ...
        while start_time < duration:
            ...
            # if distance < 40:
            if distance < 40:
                # print(f"{distance}_Sample voice detected between {start_time} and {end_time} seconds")
...
def tim_kiem_giong_noi_audio(sample_audio_file_input, test_audio_file_inputs):
    return process(sample_audio_file_input, test_audio_file_inputs)


# print(tim_kiem_giong_noi_audio(r'C:\Users\hacon\Desktop\audio_test\Qbao.wav', [r'C:\Users\hacon\Desktop\audio_test\chidoan.m4a', r'C:\Users\hacon\Desktop\audio_test\doibancungtien.m4a']))
